...
export async function enablePush(userId) {
  ...
  // Erlaubnis so nah wie möglich am Klick des Nutzers abfragen: Chrome auf
  // Android verwirft den Request sonst still (ohne Dialog), wenn zwischen
  // Klick und Abfrage zu viel Zeit vergeht (z.B. durch das Warten auf den
  // Service Worker).
